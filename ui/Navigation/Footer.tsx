    ...
    return (
        <footer className="bg-white dark:bg-black border-t border-zinc-200 dark:border-zinc-800 relative z-10">
            <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        ...
                        <div className="flex mt-8 space-x-6 text-zinc-600">
                            ...
                            <Link href={igUrl} className="hover:opacity-75" target="_blank" rel="noreferrer">
                            ...
                            <Link href={twitterUrl} className="hover:opacity-75" target="_blank" rel="noreferrer">
                                <span className="sr-only"> Twitter </span>
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                                </svg>
                            </Link>
                            <a className="hover:opacity-75 hidden" target="_blank" rel="noreferrer">
                    ...
                    <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4 text-black dark:text-white">
                        <div>
                        ...
                        <div>
                            ...
                            <nav className="flex flex-col mt-4 space-y-2 text-sm text-zinc-500 dark:text-zinc-300">
                                ...
                                <a className="hover:opacity-75"> SEO Optimization </a>
                            </nav>
                        </div>
                        <div>
                            <p className="font-medium">
                ...
                <p className="mt-8 text-xs text-zinc-800 dark:text-zinc-400 ">
                    © 2023 CRIB, LLC
                </p>
            </div>
        </footer>
