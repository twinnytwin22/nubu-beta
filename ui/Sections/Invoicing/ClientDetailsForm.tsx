                        ...
                        <div className="flex flex-col justify-center space-y-2">
                            <article className="md:grid grid-cols-2 gap-10">
                                <div className="flex flex-col">
                                    <label className="text-black dark:text-zinc-200 font-bold pb-2"
                                        htmlFor="name">Your full name</label>
                                    <input
                                        type="text"
                                        name="text"
                                        id="name"
                                ...
                                <div className="flex flex-col">
                                    <label className="text-black dark:text-zinc-200 font-bold pb-2"
                                        htmlFor="address">Enter your address</label>
                                    <input
                                        type="text"
                                        name="address"
                                        id="address"
                            ...
                            <article className="md:grid grid-cols-3 gap-10">
                                ...
                                <div className="flex flex-col">
                                    <label className="text-black dark:text-zinc-200 font-bold pb-2"
                                        htmlFor="website">Enter your website</label>
                                    <input
                                        type="url"
                                        name="website"
                                        id="website"
                                ...
                                <div className="flex flex-col">
                                    <label className="text-black dark:text-zinc-200 font-bold pb-2"
                                        htmlFor="phone">Enter your phone</label>
                                    <input
                                        type="text"
                                        name="phone"
                                        id="phone"
                            ...
                            <article className="md:grid grid-cols-2 gap-10">
                                <div className="flex flex-col">
                                    <label className="text-black dark:text-zinc-200 font-bold pb-2"
                                        htmlFor="bankName">Enter your bank name</label>
                                    <input
                                        type="text"
                                        name="bankName"
                                        id="bankName"
                            ...
                            <article className="md:grid grid-cols-2 gap-10 md:mt-16">
                                <div className="flex flex-col">
                                    <label className="text-black dark:text-zinc-200 font-bold pb-2"
                                        htmlFor="clientName">Enter your client's name</label>
                                    <input
                                        type="text"
                                        name="clientName"
                                        id="clientName"
                            ...
                            <article className="md:grid grid-cols-3 gap-10">
                                <div className="flex flex-col">
                                    <label className="text-black dark:text-zinc-200 font-bold pb-2"
                                        htmlFor="invoiceNumber">Invoice Number</label>
                                    <input
                                        type="text"
                                        name="invoiceNumber"
                                        id="invoiceNumber"
                                ...
                                <div className="flex flex-col">
                                    <label className="text-black dark:text-zinc-200 font-bold pb-2"
                                        htmlFor="invoiceDate">Invoice Date</label>
                                    <input
                                        type="date"
                                        name="invoiceDate"
                                        id="invoiceDate"
                            ...
                            <label className="text-black dark:text-zinc-200 font-bold pb-2"
                                htmlFor="notes">Additional Notes</label>
                            <textarea
                                name="notes"
                                id="notes"
                                cols={30}
